                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <h4 className={`font-medium group-hover:text-slate-900 transition-colors ${
                          ...
                          <div className="flex items-center gap-3 mt-2">
                            ...
                            {task.organization && (
                              <div className="flex items-center gap-1.5">
                                <div className={`w-2 h-2 rounded-full ${orgColors[task.organization.color] || 'bg-slate-400'}`} />
                                <span className="text-xs text-slate-500">{task.organization.name}</span>
                              </div>
                            )}
                            {/* プロジェクト */}
                            {task.project && (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 flex items-center gap-1.5 px-2 py-1 bg-slate-100 hover:bg-primary-100 hover:text-primary-600 rounded-lg text-xs transition-all"
                          >
